...
import TeamSidebar from './test';

import {setPreviousButton} from 'actions/local_storage';
import {getPreviousButton} from 'selectors/local_storage';
...
function mapStateToProps(state: GlobalState) {
    ...
    return {
        ...
        prevButton: getPreviousButton(state),
...
type Actions = {
    ...
    setPreviousButton: (button: string) => (dispatch: Dispatch<GenericAction>, getState: GetStateFunc) => void;
}
